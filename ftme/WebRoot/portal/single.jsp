				...
				<div class="section group">
					<div class="cont span_2_of_3">
						<div class="blog_posts">
							<div class="blog_date bd">
								<figure><span>${blog.day}</span>${blog.month}月</figure>
							</div>
							<div class="blog_desc bd1">
								<div class="blog_heading">
									${blog.title}
									</p>
								</div>
								<div class="section group example" style="color:#555;margin-top: 2rem;font-size: 1.8rem;line-height: 2.5rem;">
									<p>${blog.content}</p>
								</div>
								<div class="clearfix"></div>
							</div>
