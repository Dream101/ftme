...
<nav class="breadcrumb">
		...
		<span class="c-gray en">&gt;</span> 添加动态
...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin-add" action="${pageContext.request.contextPath}/news/newsSave" method="post" onsubmit="return news_add_click()">
		<input type="hidden" value="-1" id="id"/>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value=""  style="width:50%;" id="title" name="news.title">
			</div>
		</div>
		<div class="row cl">
				...
				<!--<input type="text" class="input-text" value=""  style="width:50%;"  id="companyIntroduce" name="companyinfo.companyIntroduce">
				 -->
					<textarea name="news.content" cols=""
						...
						style="width: 50%; height: 600px;"></textarea>
				</div>
		</div>
		<div class="row cl">
