...
<title>修改医院 - 医院管理</title>
</head>
<body>
<input type="hidden" name="path" class="path" value="${pageContext.request.contextPath}" />
<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页
		<span class="c-gray en">&gt;</span> 医院 管理
		<span class="c-gray en">&gt;</span> 医院 列表
		<span class="c-gray en">&gt;</span> 修改医院 
...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin-add" action="${pageContext.request.contextPath}/hospital/hospitalUpdate" method="post" onsubmit="return hospital_add_click()">
		<input type="hidden" value="${hospital.id}" name="hospital.id" id="id"/>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>医院编号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${hospital.hospitalNo}"  style="width:50%;" id="hospitalNo" name="hospital.hospitalNo">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>医院名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${hospital.hospitalname}"  style="width:50%;" id="hospitalname" name="hospital.hospitalname">
			</div>
		</div>
		<div class="row cl">
