...
<div class="page-container">
	<div class="text-c"> 
		<input type="text" name="hospitalNo" id="hospitalNo" placeholder="医院编号"  style="width:250px" class="input-text">
		<input type="text" name="hospitalname" id="hospitalname" placeholder="医院名称" style="width:250px" class="input-text">
		<button name="" id="butSel" class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i> 搜索</button>
	</div>
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="add"><a class="btn btn-primary radius" data-title="添加医院" href="${pageContext.request.contextPath}/hospital/hospitalAdd"><i class="Hui-iconfont">&#xe600;</i> 添加医院</a></span> <span class="r">共有数据：<strong>${count}</strong> 条</span> </div>
	<div class="mt-20">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/dictionary/hospital/hospital-list.js"></script>
</body>
</html>