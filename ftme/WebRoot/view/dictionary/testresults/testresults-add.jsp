...
<nav class="breadcrumb">
		...
		<span class="c-gray en">&gt;</span> 添加检测结果
...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin-add" action="${pageContext.request.contextPath}/testresults/testresultsSave" method="post" onsubmit="return testresults_add_click()">
		<input type="hidden" value="-1" id="id"/>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>检测结果：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value=""  style="width:50%;" placeholder="请输入检测结果" id="testresultsname" name="testresults.testresultsname">
			</div>
		</div>
		<div class="row cl">
