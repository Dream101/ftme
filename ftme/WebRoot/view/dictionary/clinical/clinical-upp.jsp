...
<nav class="breadcrumb">
		...
		<span class="c-gray en">&gt;</span> 修改临床诊断 
	...
	<form class="form form-horizontal" id="form-admin-add" action="${pageContext.request.contextPath}/clinical/clinicalUpdate" method="post" onsubmit="return clinical_add_click()">
		<input type="hidden" value="${clinical.id}" name="clinical.id" id="id"/>
		<input type="hidden" value="${clinical.clinicalNo}" name="clinical.id" id="id"/>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>临床诊断：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${clinical.clinicalname}"  style="width:50%;"
				 id="clinicalname" name="clinical.clinicalname">
			</div>
		</div>
		<div class="row cl">
