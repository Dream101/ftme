...
<div class="page-container">
	<div class="text-c"> <span class="select-box inline">
		...
		<span class="select-box inline">
			...
			<select class="select" id="userNo" name="userNo" style="width:100px" size="1">
				<option value="-1">---请选择医生---</option>
			</select>
		<input type="text" name="name" id="selname" placeholder="医生姓名" style="width:200px" class="input-text">
		<input type="text" name="phone" id="phone" placeholder="医生手机号" style="width:200px" class="input-text">
		<button name="" id="butSel" class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i> 搜索</button>
	</div>
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="add"><a class="btn btn-primary radius" data-title="添加医生" href="${pageContext.request.contextPath}/doctor/doctorAdd"><i class="Hui-iconfont">&#xe600;</i> 添加医生</a></span> <span class="r">共有数据：<strong>${count}</strong> 条</span> </div>
	<div class="mt-20">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/doctor/doctor-list.js"></script>
