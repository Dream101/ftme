...
<html>
	...
	<body>
		...
		<a class="btn btn-success radius r"
			...
			href="${pageContext.request.contextPath}/govern/governList"
			target="rightFrame" title="返回">返回</a>
		</nav>
		<article class="page-container">
		<form class="form form-horizontal"
			action="${pageContext.request.contextPath}/govern/governUpdate"
			method="post" id="form-admin-add" onsubmit="return govern_add_click();">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" autocomplete="off"
						style="width: 50%;" value="${user.password}" id="password" name="user.password">
				</div>
			</div>
			<%--<div class="row cl">
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/js/govern/govern-add.js">
</script>
