...
<input type="hidden" name="path" class="path" value="${pageContext.request.contextPath}" />
		<nav class="breadcrumb">上传文件
		<a class="btn btn-success radius r"
			style="line-height: 1.6em; margin-top: 3px"
			href="${pageContext.request.contextPath}/patientFront/frontPatientList?userNo='dw1234143124'"
			title="返回">返回</a>
		</nav>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/front/patient-Upload.js"></script>
</body>
</html>